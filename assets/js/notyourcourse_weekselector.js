...
/*<--	*** on window load ***	-->*/
window.addEventListener("load", notYourCourse());
/*<--	*** end on window load ***	-->*/
...
* Dependencias:
* Devuelve/resultado: Elemento gráfico que le indica al usuario que está trarando de acceder a un curso que no le corresponde y el botón vibra 
<!------------------------------------------------->*/
function triggerToast(){
    /*<--	*** toast ***	-->*/
    var toastHTML = '<i class="fa-duotone fa-clock" style="font-size:2rem; color:black; margin-right:1rem;"></i><span> Aún no es tiempo de que veas esta sección.</span>';
